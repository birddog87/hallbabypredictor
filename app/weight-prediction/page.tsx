    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-pink-100 py-12">
      <div className="container mx-auto px-4 max-w-xl">
        <div className="bg-white rounded-xl overflow-hidden shadow-xl">
          ...
          <div className="p-8">
            <Link href="/" className="text-purple-500 hover:text-purple-700 transition-colors flex items-center mb-6">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-purple-100 text-purple-500 mb-4">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12,3 C16.9705627,3 21,7.02943725 21,12 C21,16.9705627 16.9705627,21 12,21 C7.02943725,21 3,16.9705627 3,12 C3,7.02943725 7.02943725,3 12,3 Z M12,4.5 C7.85786438,4.5 4.5,7.85786438 4.5,12 C4.5,16.1421356 7.85786438,19.5 12,19.5 C16.1421356,19.5 19.5,16.1421356 19.5,12 C19.5,7.85786438 16.1421356,4.5 12,4.5 Z"></path>
                </svg>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="pounds" className="block text-xs text-gray-500 mb-1">Pounds</label>
                  ...
                  <div>
                    <label htmlFor="ounces" className="block text-xs text-gray-500 mb-1">Ounces</label>
                    <div className="relative">
                      <input
                        type="number"
                        id="ounces"
                ...
                <p className="mt-2 text-xs text-gray-500 italic">Most babies weigh between 5 lbs 8 oz and 8 lbs 13 oz.</p>
              </div>
